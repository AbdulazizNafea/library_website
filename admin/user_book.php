...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // query delete book
     ...
     $querydelete->close();
      ...
      // query view user and books for user

       $queryview = $conn->prepare("select * FROM books where email = ?");
       $queryview->bind_param('s' ,$view);
       $queryview->execute();

       $result  = $queryview->get_result();
       ...
       $queryview->close();
        ...
        $queryemail->bind_param('s' ,$view);
        $queryemail->execute();

        $result1  = $queryemail->get_result();
        $userfoundEmail = $result1->fetch_assoc();
...
<center>
            <h1 class="center"><?php echo $userfoundEmail['username'];?> - استعراض كتب</h1>
        </center>
                ...
                <div class="col-lg-4">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            ...
                            <button type="submit" name="delete" value="<?php echo $userfound['id']; ?>" class="btn btn-danger"><i class="material-icons">delete</i></button><br>delete

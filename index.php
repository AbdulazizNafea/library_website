...
<body>
    ...
    <div class="container-ms" id="view_book">
        ...
        <div class="containers">
            <h1 class="text-center">الكتب الأكثر شهرة</h1>

            <div class="card-group">

                <div class="card">
                    <a href="books/dontBeSad.pdf"><img class="card-img-top" src="img_book/dontBeSad.jpg" alt="Card image cap"></a>
                    <div class="card-body">
                        <h3 class="text-right">لا تحزن</h3>
                        <p class="text-right">ثقافة</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">عائض القرني</small>
                        </div>
                    </div>
                </div>

                <div class="card">
                    <a href="books/كن-أنت-kutub-pdf.net.pdf">
                    <img class="card-img-top" src="img_book/kutub-pdf.net_rg3pdna.png" alt="Card image cap"> </a>
                    <div class="card-body">
                        <h3 class="text-right">كن أنت</h3>
                        <p class="text-right">تنمية بشرية</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">د إيهاب حمارنة</small>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <a href="books/علم-التأثير-kutub-pdf.net.pdf" alt="Card image cap"> <img class="card-img-top" src="img_book/kutub-pdf.com_0eRcY4.jpg" alt="Card image cap"> </a>
                    <div class="card-body">
                        <h3 class="text-right">علم التاثير</h3>
                        <p class="text-right">تنمية بشرية</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">كيفين هوجان</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-group">
                ...
                <div class="card">
                    <a href="books/%D9%84%D8%A3%D9%86%D9%83-%D8%A7%D9%84%D9%84%D9%87-kutub-pdf.net.pdf"> <img class="card-img-top" src="img_book/%D9%84%D8%A3%D9%86%D9%83_%D8%A7%D9%84%D9%84%D9%87.jpg" alt="Card image cap"> </a>
                    <div class="card-body">
                        <h3 class="text-right">لأنك الله</h3>
                        <p class="text-right">دين</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">علي بن جابر الفيفي</small>
                        </div>
                    </div>
                </div>

                <div class="card">
                    <a href="books/%D8%A5%D8%BA%D9%88%D8%A7%D8%A1-%D8%A7%D9%84%D8%B9%D9%82%D9%84-%D8%A7%D9%84%D8%A8%D8%A7%D8%B7%D9%86-kutub-pdf.net.pdf"> <img class="card-img-top" src="img_book/%D8%A7%D8%BA%D9%88%D8%A7%D8%A1.jpg" alt="Card image cap"> </a>
                    <div class="card-body">
                        <h3 class="text-right">اغواءالعقل الباطن</h3>
                        <p class="text-right">علم نفس</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">روبرت هيث</small>
                        </div>
                    </div>
                </div>

                <div class="card">
                    <a href="books/%D8%A7%D9%84%D8%A8%D8%AE%D9%84%D8%A7%D8%A1-kutub-pdf.net.pdf"> <img class="card-img-top" src="img_book/%D8%A7%D9%84%D8%A8%D8%AE%D9%84%D8%A7%D8%A1.jpg" alt="Card image cap"> </a>
                    <div class="card-body">
                        <h3 class="text-right">البخلاء</h3>
                        <p class="text-right">أدب</p>
                    </div>
                    <div class="text-center">
                        <div class="card-footer">
                            <small class="text-right">الجاحظ</small>
                        </div>
                    </div>
                </div>
    ...
    <div class="containers">
        ...
        <h4 class="text-center">تنبيه: يلزم تسجيل الدخول حتى تتمكن من اضافة كتاب، اذا لم تملك حساب انقر<a href="sign_up.php"> هنا لإنشاء حساب جديد </a> </h4>
